...
class jogo:
    ...
    def janela_2_jogo(self):
        ...
        self.lb1 = Label(self.janela, text='', border=1, font=('arial',23), fg='orange', bg='pink')
        self.lb2 = Label(self.janela, text='',  border=1, font=('arial',23), fg='orange',bg='pink')
        self.lb3 = Label(self.janela, text='',  border=1, font=('arial',23), fg='orange',bg='pink')
